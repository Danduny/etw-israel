...
const slugs = Object.keys(blogArticles.he);
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const article = blogArticles.he[slug];
  if (!article) return {};
  return {
    ...
    <main>
      ...
      <article className="pt-32 pb-20 md:pt-40 md:pb-28 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          <div className="mb-8">
            <a href="/blog" className="text-brand text-sm font-medium hover:text-brand-light transition-colors">
              ← חזרה לבלוג
            </a>
          </div>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden bg-aurora">
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-xl mx-auto font-light">
            קבעו שיחה חינם ונספר לכם בדיוק מה אפשר לעשות עם העסק שלכם.
          </p>
          <a
