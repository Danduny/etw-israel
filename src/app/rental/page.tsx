...
export const metadata: Metadata = {
  ...
  description:
    "אתר פרימיום מותאם אישית בתשלום חודשי. בלי השקעה ראשונית, בלי כאב ראש. עיצוב, פיתוח, אחסון, דומיין ותחזוקה — הכל כלול.",
};
...
const tiers = [
  ...
  },
  {
    name: "עסקי",
    price: "990",
    desc: "אתר מתקדם עם פיצ׳רים נוספים",
    popular: true,
    features: [
      "הכל מהחבילה הבסיסית",
      "עד 10 עמודים",
  ...
  },
  {
    name: "פרימיום",
    price: "1,290",
    desc: "פתרון מלא לעסקים שרוצים יותר",
    features: [
      "הכל מהחבילה העסקית",
      "עמודים ללא הגבלה",
      "בלוג / חדשות",
