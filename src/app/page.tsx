...
const services = [
  {
    icon: "/images/icons/icon-platform.png",
    title: "אתר עסקי",
  ...
  {
    icon: "/images/icons/icon-analytics.png",
    title: "חנות אונליין",
  ...
  {
    icon: "/images/icons/icon-marketing.png",
    title: "שיווק במייל",
        ...
        <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="stagger-2 flex justify-center relative order-first lg:order-last">
              <div className="relative w-[220px] h-[280px] md:w-[280px] md:h-[340px] lg:w-[400px] lg:h-[480px]">
                <div className="absolute inset-0 bg-brand/20 blur-[100px] rounded-full" aria-hidden="true" />
                <Image
                  src="/images/mascot-wolf-alt.png"
                  alt="ETW Agency"
                  width={400}
                  height={480}
                  className="relative z-10 drop-shadow-[0_0_60px_rgba(137,90,246,0.4)] float"
                  priority
                />
              </div>
            </div>
